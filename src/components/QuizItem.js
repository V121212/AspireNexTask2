    ...
    <div className="col-md-6 gx-1">
      <div className="card my-3 cart">
        <div className="card-body cart-body">
          ...
          <i className="fa-solid fa-trash mx-2 delete-cart" onClick={()=>{deleteQuiz(quiz._id); props.showAlert("deleted successfully","success")}}></i>
          <i className="fa-solid fa-file-pen mx-2 update-cart" onClick={()=>{updateQuiz(quiz)}}></i>
          </div>
        </div>
      </div>
    </div>
